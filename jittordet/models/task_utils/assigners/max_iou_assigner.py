...
class AssignResult:
    ...
    def add_gt_(self, gt_labels):
        ...
        self.max_overlaps = jt.contrib.concat([
            jt.ones((self.num_gts, ), dtype=self.max_overlaps.dtype),
            self.max_overlaps
        ])
...
class MaxIoUAssigner:
    ...
    proposals will be assigned with `-1`, `0`, or a positive integer indicating
...
class MaxIoUAssignerRbbox(MaxIoUAssigner):
    ...
    def __init__(self,
                 ...
                 ignore_wrt_candidates=True,
                 iou_calculator=dict(type='BboxOverlaps2D')):
        super(MaxIoUAssignerRbbox, self).__init__(
